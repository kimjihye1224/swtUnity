...
public class HeeJoController : MonoBehaviour
{
    public static HeeJoController instance = null;
    ...
    void Update()
    {
        ...
        if (transform.position.x > 0)
        {
            ...
            this.talkText.GetComponent<Text>().text = "블루팟 커피 기대돼!";

            if (bAudioPlay == false)
            {
                bAudioPlay = true;
                this.aud.PlayOneShot(this.usualHee);
            }
        ...
        if (this.delta > this.span)
        {
            ...
            SceneManager.LoadScene("HeeJoCupSizeScene");
