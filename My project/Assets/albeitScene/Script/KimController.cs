...
{
    public static KimController instance = null;
    ...
    void Update()
    {
        ...
        if (transform.position.x > 0)
        {
            ...
            this.talkText.GetComponent<Text>().text = "커피 한잔 맛있게 부탁합니다.";

            if (bAudioPlay == false)
            {
                bAudioPlay = true;
                this.aud.PlayOneShot(this.usualKim);
            }
        ...
        if (this.delta > this.span)
        {
            ...
            SceneManager.LoadScene("KimCupSizeScene");
