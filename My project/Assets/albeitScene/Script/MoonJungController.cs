...
public class MoonJungController : MonoBehaviour
{
    public static MoonJungController instance = null;
    ...
    void Update()
    {
        ...
        if (transform.position.x > 0)
        {
            ...
            this.talkText.GetComponent<Text>().text = "커피 주문할게요!";

            if (bAudioPlay == false)
            {
                bAudioPlay = true;
                this.aud.PlayOneShot(usualMoon);
            }
        ...
        if (this.delta > this.span)
        {
            ...
            SceneManager.LoadScene("MoonJungCupSizeScene");
