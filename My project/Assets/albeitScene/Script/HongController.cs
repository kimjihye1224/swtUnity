...
public class HongController : MonoBehaviour
{
    public static HongController instance = null;
    ...
    void Update()
    {
        ...
        if (transform.position.x > 0)
        {
            ...
            this.talkText.GetComponent<Text>().text = "커피 맛있게 만들어주세요. 알겠죠?";

            if (bAudioPlay == false)
            {
                bAudioPlay = true;
                this.aud.PlayOneShot(this.usualHong);
            }
        ...
        if (this.delta > this.span)
        {
            ...
            SceneManager.LoadScene("HongCupSizeScene");
